...
public class WolfSchedulerTest {
	...
	public void testGetScheduledActivities() {
		...
		assertTrue(ws.addCourse(NAME, SECTION));
		assertTrue(ws.addCourse("CSC226", "001"));
		ws.addEvent("Lunch", "MWF", 1400, 1500, 1, "Food");
		assertTrue(ws.addCourse("CSC116", "002"));
		...
		assertEquals("MWF 2:00PM-3:00PM (every 1 weeks)", schedule[2][3]);
		//Row 3
	...
	public void testGetFullScheduledActivities() {
		...
		assertEquals("MWF 2:00PM-3:00PM (every 1 weeks)", schedule[2][5]);
