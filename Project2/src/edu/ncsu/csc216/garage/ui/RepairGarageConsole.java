...
/**
 * Simple command-line interface for a auto service garage. (There is no code
...
public class RepairGarageConsole {
	...
	private String menu = // Menu of choices
			"1) Add new vehicle\n2) Remove a vehicle\n3) Edit a vehicle tier\n4) Fill the service bays\n5) Complete servicing a vehicle\n"
					...
					+ "\nEnter Selection: ";
	private String filter = ""; // Restricts the waiting list display to vehicles whose owners' names begin with
								// the filter
	 ...
	 * service bays. If "cars.txt" is not available, the patient list is initially
	 * empty
	 */
